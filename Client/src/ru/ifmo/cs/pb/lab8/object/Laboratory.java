...
public class Laboratory implements Serializable {
      ...
      public boolean compare(Laboratory laboratory) {
            return !this.name.equals(laboratory.name) ||
                   !(this.coordinates.getX() == laboratory.coordinates.getX()) ||
                   !(this.coordinates.getY() == laboratory.coordinates.getY()) ||
                   !(this.difficulty.equals(laboratory.difficulty));
      }
